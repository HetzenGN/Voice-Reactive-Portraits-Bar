# Voice Reactive Portraits Bar Companion Privacy Policy

Last updated: August 31, 2026

## Overview

Voice Reactive Portraits Bar Companion is a browser companion extension for the Voice Reactive Portraits Bar Companion module for Foundry VTT. Its sole purpose is to relay limited Discord StreamKit voice-state information from Discord StreamKit to a Foundry Virtual Tabletop game explicitly selected by the user.
...
* Companion connection and heartbeat information
...
Persistent Discord-to-Foundry portrait mappings are managed by the separately installed Voice Reactive Portraits Bar module within the user's own Foundry VTT installation.
...
**scripting** allows the extension to verify that the selected tab is a compatible Foundry VTT game and communicate with the installed Voice Reactive Portraits Bar Companion module.
